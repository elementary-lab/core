...
export class Logger implements LoggerInterface {
  ...
  public debug(message: string, context?: any, category?: string) {
    this.dispatcher.log(message, LogLevel.DEBUG, context, category);
  }

  public emergency(message: string, context?: any, category?: string) {
    this.dispatcher.log(message, LogLevel.EMERGENCY, context, category);
  }

  public error(message: string, context?: any, category?: string) {
    this.dispatcher.log(message, LogLevel.ERROR, context, category);
  }

  public info(message: string, context?: any, category?: string) {
    this.dispatcher.log(message, LogLevel.INFO, context, category);
  }

  public profile(message: string, context?: any, category?: string) {
    this.dispatcher.log(message, LogLevel.PROFILE, context, category);
  }

  public warn(message: string, context?: any, category?: string) {
